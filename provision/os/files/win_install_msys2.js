...
Controller.prototype.IntroductionPageCallback = function() {
    ...
    print("IntroductionPageCallback: gui.clickButton(buttons.NextButton)");
}
Controller.prototype.TargetDirectoryPageCallback = function() {    
    ...
    gui.clickButton(buttons.NextButton);
    print("TargetDirectoryPageCallback: gui.clickButton(buttons.NextButton)");
}
Controller.prototype.StartMenuDirectoryPageCallback = function() {
    gui.clickButton(buttons.NextButton);
    print("StartMenuDirectoryPageCallback: gui.clickButton(buttons.NextButton)");
}
Controller.prototype.PerformInstallationPageCallback = function() {
    gui.clickButton(buttons.CommitButton);
    print("PerformInstallationPageCallback: gui.clickButton(buttons.CommitButton)");
}
Controller.prototype.FinishedPageCallback = function() {
    ...
    print("FinishedPageCallback: gui.clickButton(buttons.FinishButton)");
}
